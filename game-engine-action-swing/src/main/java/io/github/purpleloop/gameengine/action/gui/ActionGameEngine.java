...
public class ActionGameEngine implements IGameEngine, ThreadObserver {
	 ...
	 */
	public ActionGameEngine(IDataFileProvider df, String confFileName, GameEngineUI ui) throws EngineException {
	...
	public void startGame() throws EngineException {
		...
		if (!hasRunningGame()) {
			...
			throw new EngineException("Unable to start a new game, another game thread is still running.");
		}
	}
