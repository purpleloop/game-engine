...
public class KeyboardController implements KeyListener, IController {
    ...
    /**
     * FIXME : A dummy legacy constant - AFAIR was for single controller
     * adaptation.
     */
     ...
     * 
     * @param gameEngine Game engine that will be connected for transmit key
     *            inputs
     */
    ...
    public void keyPressed(KeyEvent keyEvent) {
        ...
        if (commonAction != null) {
            ...
            String action = keyMap.getActionForKey(keyCode);
            if (action != null) {
                ...
                LOG.debug("Unmapped key pressed event : " + KeyEvent.getKeyText(keyCode) + " ("
                        + keyCode + ") ");
            }
        }
    ...
    public void keyReleased(KeyEvent evt) {
        ...
        if (!keyActionRegistry.isMappedKey(keyCode)) {
            ...
            if (action != null) {
                ...
                LOG.debug("Unmapped key released event : " + KeyEvent.getKeyText(keyCode) + " ("
                        + keyCode + ") ");
            }
        }
