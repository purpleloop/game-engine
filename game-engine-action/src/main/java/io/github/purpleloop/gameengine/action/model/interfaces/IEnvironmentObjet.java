...
public interface IEnvironmentObjet {
     ...
     */
    void evolve() throws EngineException;

    /**
     * @return returns the animation sequence number of the object.
     * 
     *         FIXME Animation sequence number : To improve as this should not
     *         be in the model.
     */
    int getAnimationSequence();

    /**
     * @return Returns the collision rectangle : the portion of space occupied
     *         by the agent.
     */
    ...
    /** @return a string usable for debugging purpose */
    String getExtraDebugInfo();
