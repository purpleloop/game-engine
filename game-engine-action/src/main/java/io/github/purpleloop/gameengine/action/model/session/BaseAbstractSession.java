...
import io.github.purpleloop.gameengine.action.model.level.LevelProvider;
 ...
 * 
 * A session spreads across several levels.
 * For sake of simplicity, the current level is the active environment and is unique at a given time.
 */
public abstract class BaseAbstractSession implements ISession {
	...
	public BaseAbstractSession(IGameEngine gameEngine) throws EngineException {
        ...
        levelProvider = new LevelProvider(gameEngine);
    ...
    private void setupNextLevel() throws EngineException {
        ...
        currentEnvironment = levelProvider.getNextLevel(this);
