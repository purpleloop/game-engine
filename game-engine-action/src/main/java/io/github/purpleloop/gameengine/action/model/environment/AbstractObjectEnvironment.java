 ...
 */
public abstract class AbstractObjectEnvironment extends CommonAbstractEnvironment implements IEnvironment {
	...
	/**
	 * Makes each object of the environment evolve according to the laws like the
	 * physics of the environment and of the game. Before evolution, the agents are
	 * allowed to act according to the external controls or their internal behavior.
	 */
	...
	/**
	 * @return The game level that serves as reference for the static structure of
	 *         the environment
	 */
